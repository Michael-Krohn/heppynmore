...
def hadd_files(target_file,target_dir,source_dir):
	...
	__fileslist=''
	os.system('xrdfsls -u /store/user/lpchbb/HeppyNtuples/V23/QCD_HT700to1000_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/VHBB_HEPPY_V23_QCD_HT700to1000_TuneCUETP8M1_13TeV-madgraphMLM-Py8__spr16MAv2-puspr16_80r2as_2016_MAv2_v0_ext1-v1/160717_082929/0000')
	__complete_path=[]
	__list_of_files=[]
...
#    		        __list_of_files.extend(['%s/%s' %('root://cmseos.fnal.gov//store/user/mkrohn/HHTo4b/V23/heppyTrees -S /eos/uscms/store/user/lpchbb/HeppyNtuples/V23/QCD_HT700to1000_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/VHBB_HEPPY_V23_QCD_HT700to1000_TuneCUETP8M1_13TeV-madgraphMLM-Py8__spr16MAv2-puspr16_80r2as_2016_MAv2_v0_ext1-v1/160717_082929/0000', __file)]) # __tuple_entry[0] is the full path of the files
